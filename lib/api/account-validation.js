  ...
  password(password, options) {
    ...
    if (passwordOptions.validationLevel === "exists") {
      ...
      errors.push({
        ...
        i18nKeyReason: "accountsUI.register.step1.insecurePassword"
      });
    } else if (password.length > 128) {
      errors.push({
        error: "INVALID_PASSWORD",
        reason: "Password must be less than 128 characters long.",
        i18nKeyReason: "accountsUI.register.step1.conflict"
      });
    }
